          ...
          <div className="flex items-center gap-1 rounded-full border border-border bg-secondary/60 p-1">
            <button
              ...
              className={cn(
                ...
                tab === "song" ? "bg-primary text-primary-foreground" : "text-muted-foreground",
              )}
            >
              Nummer
            </button>
            <button
              ...
              className={cn(
                "flex items-center gap-1.5 rounded-full px-4 py-1.5 text-sm font-bold transition-colors",
                tab === "video" ? "bg-primary text-primary-foreground" : "text-muted-foreground",
              )}
            >
              Video
              <span className="rounded-full bg-foreground/10 px-1.5 py-0.5 text-[9px] font-bold uppercase tracking-wide text-muted-foreground">
                Binnenkort
              </span>
            </button>
          </div>
        ...
        <div className="flex min-h-0 flex-1 flex-col items-center justify-center px-6 pb-10">
          {tab === "song" ? (
            <div className="flex w-full max-w-md flex-col items-center">
              {/* Cover */}
              <div className="aspect-square w-full max-w-sm overflow-hidden rounded-2xl bg-secondary shadow-2xl glow-yellow">
                {current.thumbnail_url ? (
                  <img
                    src={current.thumbnail_url}
                    alt={current.title}
            ...
            // Video tab — structured placeholder; a video player drops in here later.
            <div className="flex w-full max-w-2xl flex-col items-center justify-center">
              <div className="flex aspect-video w-full items-center justify-center rounded-2xl border border-border bg-secondary/40">
                <div className="text-center">
                  <p className="font-display text-xl font-extrabold text-foreground">Binnenkort</p>
                  <p className="mt-1 text-sm text-muted-foreground">
                    Videoclips zijn nog niet beschikbaar.
                  </p>
                </div>
              </div>
            </div>
